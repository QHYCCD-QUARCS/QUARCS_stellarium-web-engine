...
| 组件文件 | 组件名称 | 代码行数 | 标识数量 | 状态 |
|---------|---------|---------|---------|------|
| components/CircularButton.vue | CircularButton | 391 | 2 | ✅ 已完成 |
| components/Dial-Knob.vue | Dial-Knob | 386 | 3 | ✅ 已完成 |
| components/RPI-Hotspot.vue | HotspotDialog | 350 | 5 | ✅ 已完成 |
...
| components/Red-Box.vue | Red-Box | 115 | 2 | ✅ 已完成 |
| components/Settings-Dialog-Focuser.vue | Settings-Dialog-Focuser | 111 | 10 | ✅ 已完成 |
| components/Settings-Dialog-Guider.vue | Settings-Dialog-Guider | 111 | 11 | ✅ 已完成 |
| components/Settings-Dialog-Mount.vue | Settings-Dialog-Mount | 107 | 10 | ✅ 已完成 |
| components/MessageBox.vue | MessageBox | 102 | 1 | ✅ 已完成 |
| components/observing-panel.vue | observing-panel | 82 | 2 | ✅ 已完成 |
| components/ProgressBar.vue | ProgressBar | 78 | 1 | ✅ 已完成 |
| components/CFWSelectBtnBar.vue | CFWSelectBtnBar | 68 | 2 | ✅ 已完成 |
| components/Settings-Dialog-PoleCamera.vue | Settings-Dialog-PoleCamera | 67 | 7 | ✅ 已完成 |
| components/bottom-button.vue | bottom-button | 64 | 1 | ✅ 已完成 |
| components/gui-loader.vue | gui-loader | 53 | 1 | ✅ 已完成 |
