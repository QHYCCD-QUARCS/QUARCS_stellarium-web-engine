<template>
  <v-dialog max-width='300' v-model="$store.state.showDeviceSettingsDialog_PoleCamera" data-testid="ui-settings-dialog-pole-camera-root" :data-state="$store.state.showDeviceSettingsDialog_PoleCamera ? 'open' : 'closed'"> <!-- showDeviceSettingsDialog_Mount -->
